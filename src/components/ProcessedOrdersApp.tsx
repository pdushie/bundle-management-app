...
export default function ProcessedOrdersApp() {
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(() => {
      console.log('ProcessedOrdersApp: Polling interval triggered');
      fetchProcessedOrders();
    }, 15000);
              ...
              <table className="w-full min-w-[600px]">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Status</th>
                  </tr>
                </thead>
