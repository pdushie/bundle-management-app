 ...
 * This provides an alternative to the nested dynamic route structure
 * that was causing issues with Next.js App Router
 */

// PUT method for assigning a user to a pricing profile
